nominaController.controller('AusentismosCtrl', ['$scope', '$http', '$rootScope', 'ausentismosService', 'contratosService', 'descuentoService', 'conceptosService', 'empresaService', 'uiGridConstants', '$mdDialog', '$mdMedia', '$modal', '$mdToast',
    function($scope, $http, $rootScope, ausentismosService, contratosService, descuentoService, conceptosService, empresaService, uiGridConstants, $mdDialog, $mdMedia, $modal, $mdToast) {
        ...
        function loadConceptos() {
            var conceptosArgs = { relacionadoCon: "ausentismo" };
